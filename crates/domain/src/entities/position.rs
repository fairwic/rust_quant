...
impl Position {
    ...
    pub fn calculate_pnl(&mut self) {
        let price_diff = match self.side {
            PositionSide::Long => self.current_price.value() - self.entry_price.value(),
            PositionSide::Short => self.entry_price.value() - self.current_price.value(),
