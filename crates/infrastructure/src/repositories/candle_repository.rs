...
use rust_quant_domain::{Candle, Timeframe, Price, Volume};
...
impl CandleRepository for SqlxCandleRepository {
    async fn find_candles(
        ...
        let candles = entities
            .into_iter()
            .filter_map(|entity| {
                match entity.to_domain(symbol.to_string(), timeframe) {
