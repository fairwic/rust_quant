...
pub(super) const MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V3_RESEARCH_PRESET: &str =
    "research_momentum_short_04sl_06r_15m_support_breakdown_d5_72_pchg1p5_12_vol11_dist5_v3";
pub(super) const MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V3_RESEARCH_ENTRY_RULE_VERSION:
    &str = "rank_radar_15m_short_r04_06r_15msup_brkdn_d5_72_p1p5_12_vol11_d5_v3";
pub(super) const MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V4_RESEARCH_PRESET: &str =
    "research_momentum_short_04sl_06r_15m_support_breakdown_d5_72_pchg1_12_vol10_dist8_v4";
pub(super) const MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V4_RESEARCH_ENTRY_RULE_VERSION:
    &str = "rank_radar_15m_short_r04_06r_15msup_brkdn_d5_72_p1_12_vol10_d8_v4";
pub(super) const MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_065R_DELTA1_100_V5_RESEARCH_PRESET:
    &str =
    ...
    pub(super) fn from_str(value: &str) -> Result<Self> {
        match value.trim().to_ascii_lowercase().as_str() {
            ...
            MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V3_RESEARCH_PRESET => {
                Ok(Self::ResearchMomentumShort04Sl06r15mSupportBreakdownDelta5To72V3)
            }
            MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V4_RESEARCH_PRESET => {
                Ok(Self::ResearchMomentumShort04Sl06r15mSupportBreakdownDelta5To72V4)
            }
    ...
    pub(super) fn append_args(self, args: &mut Vec<String>) {
        match self {
            ...
            Self::ResearchMomentumShort04Sl06r15mSupportBreakdownDelta5To72V3 => {
                args.extend([
                    "--paper-outcome-entry-rule-version".to_string(),
                    MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V3_RESEARCH_ENTRY_RULE_VERSION
                        .to_string(),
                    "--event-source".to_string(),
                    "raw_state".to_string(),
                    "--trade-direction".to_string(),
            ...
            Self::ResearchMomentumShort04Sl06r15mSupportBreakdownDelta5To72V4 => {
                args.extend([
                    "--paper-outcome-entry-rule-version".to_string(),
                    MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_06R_DELTA5_72_V4_RESEARCH_ENTRY_RULE_VERSION
                        .to_string(),
                    "--event-source".to_string(),
                    "raw_state".to_string(),
                    "--trade-direction".to_string(),
            ...
            Self::ResearchMomentumShort04Sl065r15mSupportBreakdownDelta1To100V5 => {
                args.extend([
                    "--paper-outcome-entry-rule-version".to_string(),
                    MOMENTUM_SHORT_15M_SUPPORT_BREAKDOWN_04SL_065R_DELTA1_100_V5_RESEARCH_ENTRY_RULE_VERSION
                        .to_string(),
                    "--event-source".to_string(),
                    "raw_state".to_string(),
                    "--trade-direction".to_string(),
