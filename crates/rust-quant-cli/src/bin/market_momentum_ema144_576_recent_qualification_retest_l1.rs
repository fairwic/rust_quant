...
use rust_quant_cli::app::market_velocity_event_backtest::ema144_576_breakout_retest_l1::persistent_dynamic_retest_v2::run_v3_l1_scan;
use std::path::PathBuf;

/// V3 只允许调用方指定报告路径，所有研究参数均来自预注册常量。
...
/// 执行 V3 Research-only L1 扫描，不读取任何结果标签。
#[tokio::main]
