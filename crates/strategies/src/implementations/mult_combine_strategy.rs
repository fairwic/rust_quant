...
impl UtBootStrategy {
    pub fn get_trade_signal(candles_5m: &[CandlesEntity], key_value: f64, atr_period: usize, heikin_ashi: bool) -> SignalResult {
        ...
        if candles_5m.len() >= atr_period + 1 {
            ...
            for (i, candle) in candles_5m[start_index..].iter().enumerate() {
                ...
                warn!("pre_ema_value:{},prev_xatr_trailing_stop{}",prev_ema_value,prev_xatr_trailing_stop);
                ...
                warn!("current_atr:{},prev_xatr_trailing_stop:{},ema:{},current_price:{},xatr_trailing_stop:{},above:{},below:{},pre_ema_value:{},prev_xatr_trailing_stop{}",
                    current_atr,prev_xatr_trailing_stop,ema_value, current_price, xatr_trailing_stop, above, below,prev_ema_value,prev_xatr_trailing_stop);
    ...
    pub async fn run_test(
        ...
        let res = run_test(
            |candles| Self::get_trade_signal(candles, ut_boot_strategy.key_value, ut_boot_strategy.atr_period, ut_boot_strategy.heikin_ashi),
            candles_5m,
            fib_levels,
            max_loss_percent,
            min_data_length,
