...
impl UtBootStrategy {
    ...
    // pub async fn run_test(candles_5m: &Vec<CandlesEntity>, fib_levels: &Vec<f64>, key_value: f64, atr_period: usize, heikin_ashi: bool) -> (f64, f64, usize, Vec<TradeRecord>) {
